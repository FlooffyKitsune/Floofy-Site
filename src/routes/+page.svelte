...
<style lang="scss">
    ...
    @font-face {
        ...
        font-style: normal;
        font-weight: 400;
        src: url("$lib/fonts/nostromo-regular-black.otf");
    }
    @font-face {
        font-family: "Nostromo Outline";
        font-style: normal;
        font-weight: 400;
        src: url("$lib/fonts/nostromo-outline-black.otf");
    }
    ...
    * {
    ...
    .landing-container {
        ...
        justify-content: space-between;
        height: 45rem;
        background-image: url("$lib/images/landing.jpg");
